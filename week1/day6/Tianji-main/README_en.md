1️⃣ run/demo_agent_metagpt.py

2️⃣ tianji/agents/metagpt_agents/utils/json_from.py

3️⃣ tianji/agents/metagpt_agents/utils/helper_func.py

4️⃣ tianji/agents/metagpt_agents/utils/agent_llm.py

5️⃣ tianji/agents/metagpt_agents/intentRecognition/role.py

6️⃣ tianji/agents/metagpt_agents/intentRecognition/action.py

7️⃣ tianji/agents/metagpt_agents/answerBot/role.py

8️⃣ tianji/agents/metagpt_agents/answerBot/action.py

9️⃣ tianji/agents/metagpt_agents/sceneRefinement/role.py

🔟 tianji/agents/metagpt_agents/sceneRefinement/action.py

1️⃣1️⃣ tianji/agents/metagpt_agents/searcher/role.py

1️⃣2️⃣ tianji/agents/metagpt_agents/searcher/action.py

1️⃣3️⃣ tianji/agents/metagpt_agents/utils/scene_attribute.json
...
- [天机 Tianji](#天机-tianji)
  - [What You Will Learn in Tianji 🍉](#what-you-will-learn-in-tianji-)
  ...
  - [Examples](#examples)
    - [Fine-tuning - Blessing Module](#fine-tuning---blessing-module)
    - [Prompt - How to Make a Toast](#prompt---how-to-make-a-toast)
    - [Knowledge Base - xxx](#knowledge-base---xxx)
